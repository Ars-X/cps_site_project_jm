let openMenuBtn = document.querySelector(".circle-btn--burger"),
  menu = document.querySelector(".menu"),
  closeMenuBtn = menu.querySelector(".circle-btn--close"),
  container = document.querySelector(".container"),
  callBtn = document.querySelectorAll(".circle-btn--call"),
  feedbackBtn = document.querySelectorAll(".circle-btn--chat"),
  modalCall = document.querySelector(".modal--call"),
  modalFeedback = document.querySelector(".modal--feedback"),
  modalActive = "modal--active",
  menuActive = "menu--active",
  closeCallBtn = modalCall.querySelector(".circle-btn--close"),
  closeFeedbackBtn = modalFeedback.querySelector(".circle-btn--close");
